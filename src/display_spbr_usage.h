...
//-----
inline void displayLoopImage_OpeningMessage ( std::ostream& out = std::cout )
{
  std::cout << std::endl;
  std::cout << LOOPIMAGE_APP_TITLE << std::endl;
  std::cout << "               " << SOPBR_VERSION << std::endl;
  std::cout << std::endl;
  std::cout << "                " << DATE << std::endl;
  std::cout << AUTHOR << std::endl;
...
//-----
inline void displayLoopImage_Usage ( std::ostream& out = std::cout )
{
    out << " USAGE : spbr_loop_image file1.spbr file2.spbr ..." << std::endl;
//    out << " HELP  : spbr -h"           << std::endl;
    out << std::endl;
}
...
inline void displaySPBRCommands ( std::ostream& out ) 
{
    ...
    out << "  #/LoopImageCreation end_angle num_images axis image_file_name_head" << std::endl;
    out << "    (default: 360, 180, Y, ./IMAGE_DATA/image)" << std::endl;
